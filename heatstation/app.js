...
const TOUR_KF = [
  ...
  { pos: [3.80, 1.00, -0.20], look: [6.153, 1.330, 0.132] },  // 1 二级泵#1 推近特写（x3.8 最近安全位≈2.4m）
  { pos: [3.80, 0.95, -0.55], look: [6.153, 1.330, 1.339] },  // 2 二级泵#2（低姿·沿走廊 z 偏移成弧线）
  { pos: [3.80, 0.95, -0.55], look: [7.236, 1.755, -3.036] }, // 3 环视停顿①：机位不动，look 横扫至循环泵#1
  { pos: [3.70, 1.10, -0.95], look: [8.282, 1.956, -2.901] }, // 4 循环泵#2（机位抬升 y1.1）
  { pos: [3.70, 1.00, -1.40], look: [7.880, 1.341, -4.914] }, // 5 补水泵#1（退 x3.7 留净距余量）
  { pos: [3.70, 1.00, -1.40], look: [7.917, 1.353, -5.273] }, // 6 环视停顿②：机位不动，look 横扫至补水泵#2
